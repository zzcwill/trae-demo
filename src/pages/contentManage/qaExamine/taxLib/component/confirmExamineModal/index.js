...
function DeleteModal(props) {
  const { text = '正在进行删除操作', descript = '删除后将无法恢复，是否继续要删除？', visible = false, onCancel, onOk, okText ,title, descriptColor = '#FF3B30'} = props;

  return (
    <Modal title={title} visible={visible} onCancel={onCancel} width={420} onOk={onOk} okText={okText} >
